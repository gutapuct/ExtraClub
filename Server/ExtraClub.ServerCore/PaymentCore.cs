...
namespace ExtraClub.ServerCore
{
    public static class PaymentCore
    {
        ...
        internal static void ProcessBasket(ExtraEntities context, Division division, BarOrder barOrder, PaymentDetails details, Customer customer, User user, IEnumerable<PayableItem> basket)
        {
        ...
        private static void ProcessCustomerCard(ExtraEntities context, Division division, BarOrder barOrder, PaymentDetails details, Customer customer, User user, IEnumerable<PayableItem> basket)
        {
            var bonus = 0m;
            ...
            var ctype = context.GetObjectByKey(new EntityKey("ExtraEntities.CustomerCardTypes", "Id", ccg.CardTypeId)) as CustomerCardType;
        ...
        private static void ProcessTicektPayment(ExtraEntities context, Division division, BarOrder barOrder, PaymentDetails details, Customer customer, User user, IEnumerable<PayableItem> basket)
        {
            try
            {
        ...
        private static bool ProcessBarGoods(ExtraEntities context, Division division, BarOrder barOrder, PaymentDetails details, Customer customer, User user, IEnumerable<PayableItem> basket)
        {
                ...
                if(details.Success)
                {
                    ...
                    if(items.Count() > 0)
                    {
                        if(items.First() is TicketReturnPosition)
                        {
                            ...
                            if(st == null)
                            {
                                using(var c1 = new ExtraEntities())
                                {
        ...
        internal static void ProcessTicketGood(ExtraEntities context, IEnumerable<ServiceModel.PayableItem> basket, User user, Division division, PaymentDetails details, Customer customer, bool isCashless, BarOrder barOrder)
        {
        ...
        public static int GetFreezesAmount(ExtraEntities context, Guid companyId, Guid ticketTypeId)
        {
        ...
        private static bool ChargeUnits(ExtraEntities context, Ticket ticket, Customer customer, User user, int amount)
        {
            while(amount > 0)
            {
        ...
        internal static void ProcessTicketChangeGood(ExtraEntities context, TicketChangeGood ticketChangeGood, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static void ProcessTicketRebillGood(ExtraEntities context, TicketRebillGood ticketRebillGood, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static void ProcessTicketFreeze(ExtraEntities context, TicketFreezeGood ticketFreezeGood, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static Guid ProcessChildrenRoom(ExtraEntities context, ServiceModel.Turnover.ChildrenRoomGood childrenRoomGood, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static void ProcessSolariumVisit(ExtraEntities context, ServiceModel.Turnover.SolariumGood solariumGood, User user, Division division, PaymentDetails details, Customer customer)
        {
            customer.InitEssentials();
        ...
        internal static void ProcessRentPayment(ExtraEntities context, RentPayment rentPayment, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static void ProcessCloseRentPayment(ExtraEntities context, CloseRentPayment closeRentPayment, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static void ProcessDepositGood(ExtraEntities context, DepositGood depositGood, User user, Division division, PaymentDetails details, Customer customer)
        {
        ...
        internal static void ProcessCashlessBasket(ExtraEntities context, Division division, BarOrder barOrder, PaymentDetails details, Customer customer, User user, IEnumerable<PayableItem> basket)
        {
            if(basket.Count() > 0)
            {
                if(basket.First() is BarPointGood)
