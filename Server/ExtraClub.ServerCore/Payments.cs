...
namespace ExtraClub.ServerCore
{
    ...
    {
        internal static void ProcessBonusPayment(ExtraEntities context, PaymentDetails details)
        {
        ...
        internal static void ProcessMoneyPayment(ExtraEntities context, PaymentDetails details)
        {
                var customer = context.Customers.FirstOrDefault(c => c.Id == details.CustomerId);
