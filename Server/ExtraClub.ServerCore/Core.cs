...
namespace ExtraClub.ServerCore
{
    public static partial class Core
    {
        ...
        public static IList<Guid> PostEntities(string entitySetName, IEnumerable changes)
        {
            using(var context = new ExtraEntities())
            {
                ...
                foreach(var obj in changes)
                {
                    ...
                    try
                    {
                        orig = context.GetObjectByKey(new EntityKey("ExtraEntities." + entitySetName, "Id", obj.GetValue("Id")));
                    }
        ...
        public static string GetTicketNumber(ExtraEntities context, Company company)
        {
        ...
        private static void InitCustomer(Customer res, ExtraEntities context)
        {
        ...
        private static void InitCustomerPresence(ExtraEntities context, Customer res)
        {
        ...
        private static void ProcessAcquaintanceCorrection(ExtraEntities context, Customer customer)
        {
        ...
        public static void PostGoodAction(Guid actionId, string actionName, double discount, IEnumerable<KeyValuePair<Guid, int>> goods, bool isActive)
        {
            ...
            using(var context = new ExtraEntities())
            {
                ...
                {
                    action = context.GetObjectByKey(new EntityKey("ExtraEntities.GoodActions", "Id", actionId)) as GoodAction;
        ...
        public static void SetObjectActive(string collectionName, Guid id, bool isActive)
        {
            ...
            using(var context = new ExtraEntities())
            {
                ...
                var obj = context.GetObjectByKey(new EntityKey("ExtraEntities." + collectionName, "Id", id));
                if(obj != null)
                {
        ...
        public static Guid PostNewDictionaryElement(Guid dictionaryId, string newElementName)
        {
            ...
            using(var context = new ExtraEntities())
            {
                ...
                var type = Type.GetType(String.Format("ExtraClub.ServiceModel.{0}, ExtraClub.ServiceModel", dictInfo.EntityTypeName));
        ...
        private static void TestExistance(ExtraEntities context, Type elementType, DictionaryInfo dictInfo, string elementName, StringComparison comparison)
        {
            var displayRowName = Thread.CurrentThread.CurrentCulture.Name == "ru-RU" ? dictInfo.DisplayRow : dictInfo.DisplayRowEn;
        ...
        public static void PostRenameDictionaryElement(Guid dictionaryId, Guid elementGuid, string elementName)
        {
            ...
            using(var context = new ExtraEntities())
            {
                ...
                var obj = context.GetObjectByKey(new System.Data.EntityKey("ExtraEntities." + dictInfo.EntitySetName, dictInfo.IdRow, elementGuid));
        ...
        public static void UpdateCustomerForm(Customer customer)
        {
            ...
            using(var context = new ExtraEntities())
            {
                var originalCustomer = context.GetObjectByKey(new EntityKey("ExtraEntities.Customers", "Id", customer.Id)) as Customer;
        ...
        public static string UpdateInvitor(Guid invitedId, Guid invitorId)
        {
            using(var context = new ExtraEntities())
            {
                var invitor = context.GetObjectByKey(new EntityKey("ExtraEntities.Customers", "Id", invitorId)) as Customer;
                ...
                var customer = context.GetObjectByKey(new EntityKey("ExtraEntities.Customers", "Id", invitedId)) as Customer;
        ...
        public static void PostCustomerAddress(Guid customerId, string metro, string index, string city, string street, string other)
        {
            using(var context = new ExtraEntities())
            {
                var customer = context.GetObjectByKey(new EntityKey("ExtraEntities.Customers", "Id", customerId)) as Customer;
        ...
        public static void PostTicketTypeTreatmentTypes(Guid ticketTypeId, List<Guid> treatmentTypes)
        {
            using(var context = new ExtraEntities())
            {
                var tt = context.GetObjectByKey(new EntityKey("ExtraEntities.TicketTypes", "Id", ticketTypeId)) as TicketType;
                tt.TreatmentTypes.Clear();
                foreach(var i in treatmentTypes)
                {
                    tt.TreatmentTypes.Add(context.GetObjectByKey(new EntityKey("ExtraEntities.TreatmentTypes", "Id", i)) as TreatmentType);
                }
                context.SaveChanges();
            }
        }
        ...
        public static void PostCompany(Company company)
        {
            using(var context = new ExtraEntities())
            {
                var orig = context.GetObjectByKey(new System.Data.EntityKey("ExtraEntities.Companies", "CompanyId", company.CompanyId));
        ...
        public static void PostDivision(Division division)
        {
            using(var context = new ExtraEntities())
            {
                var orig = context.GetObjectByKey(new System.Data.EntityKey("ExtraEntities.Divisions", "Id", division.Id));
                context.Detach(orig);
        ...
        public static List<int> GetAvailableShelfNumbers(Guid divisionId, bool isSafe)
        {
            using(var context = new ExtraEntities())
            {
                ...
                var div = context.GetObjectByKey(new System.Data.EntityKey("ExtraEntities.Divisions", "Id", divisionId)) as Division;
        ...
        public static List<Guid> GetEmployeeIdsWithPermission(Guid divisionId, string permissionName)
        {
            ...
            {
                var div = context.Divisions.Single(i => i.Id == divisionId);
                return UserManagement.GetEmployeesWithPermission(new ExtraEntities(), div.CompanyId, divisionId, permissionName).Select(i => i.Id).ToList();
            }
        }
        ...
        private static void SetCorrection<T>(ExtraEntities context, Ticket ticket, User user, string prop, T newValue, string comment)
        {
        ...
        private static void SetCorrectionNullable(ExtraEntities context, Ticket ticket, User user, string prop, DateTime? newValue, string comment)
        {
        ...
        {
            return new ExtraEntities().SshFiles.Single(i => i.Id == fileId);
        }
        ...
        public static void PostTicketTypeCustomerCardTypes(Guid ttId, Guid[] ccTypes)
        {
            using(var context = new ExtraEntities())
            {
                var tt = context.GetObjectByKey(new EntityKey("ExtraEntities.TicketTypes", "Id", ttId)) as TicketType;
                tt.CustomerCardTypes.Clear();
                foreach(var i in ccTypes)
                {
                    tt.CustomerCardTypes.Add(context.GetObjectByKey(new EntityKey("ExtraEntities.CustomerCardTypes", "Id", i)) as CustomerCardType);
                }
                context.SaveChanges();
            }
        }
        ...
        public static string GetFromSite(Guid divisionId, DateTime fromTime)
        {
            using(var context = new ExtraEntities())
            {
                ...
                sb.AppendLine("Новые контакты с сайта www.ExtraClub.ru:");
