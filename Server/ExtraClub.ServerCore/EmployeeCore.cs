...
namespace ExtraClub.ServerCore
{
    public static class EmployeeCore
    {
        ...
        public static List<Job> GetJobs(Guid divisionId, ExtraEntities context)
        {
            context = context ?? new ExtraEntities();
        ...
        public static Guid PostJobPlacementChange(JobPlacement jobPlacement, ExtraEntities context = null, bool save = true)
        {
            context = context ?? new ExtraEntities();
            var user = UserManagement.GetUser(context);
        ...
        public static Guid PostEmployeeFire(Guid employeeId, DateTime fireDate, string fireCause, bool cardReturned, decimal totalToPay, decimal bonus, decimal ndfl, string logMessage)
        {
            using (var context = new ExtraEntities())
            {
                ...
                if (spType == null)
                {
                    using (var con = new ExtraEntities())
                    {
        ...
        public static Guid PostEmployeeCategoryChange(Guid employeeId, Guid categoryId, ExtraEntities context = null, bool saveChs = true)
        {
            context = context ?? new ExtraEntities();
        ...
        /// <returns></returns>
        private static KeyValuePair<DateTime, int>? GetAvailVacationDays(ExtraEntities context, Employee employee, DateTime minDate, int recDays)
        {
        ...
        public static List<EmployeeScheduleProposalElement> GetEmployeeVacationsSchedule(Guid listId, ExtraEntities context = null)
        {
            context = context ?? new ExtraEntities();
            var res = new List<EmployeeScheduleProposalElement>();
        ...
        private static int GetWorkHrs(ExtraEntities context, Job job, DateTime start)
        {
        ...
        private static decimal CalculateSalaryForMonth(ExtraEntities context, JobPlacement jp, DateTime calcStart, ref string log)
        {
            var res = jp.Salary;
        ...
        private static decimal GetSales(ExtraEntities context, DateTime calcStart, Guid divisionId)
        {
