...
namespace ExtraClub.ServerCore
{
    public partial class CustomReports
    {
        ...
        public DataTable GetEmployeesVisitReport(DateTime start, DateTime end, Guid divisionId)
        {
            using(var context = new ExtraEntities())
            {
                ...
                emps.AsParallel().ForAll(emp =>
                {
                    ...
                    {
                        using(var innerContext = new ExtraEntities())
                        {
        ...
        private decimal GetAvgBill(IEnumerable<DateTime> visitsSrc, IEnumerable<object> totalUnitsSrc, DateTime st, DateTime fin, ExtraEntities context, Guid divisionId)
        {
        ...
        private decimal? GetGoodSpis(ExtraEntities context, DateTime st, DateTime fin, Division div, Good good, Storehouse store)
        {
            var outcome = 0;
        ...
        private decimal? GetGoodOutcome(ExtraEntities context, DateTime st, DateTime fin, Division div, Good good, Storehouse store)
        {
            var outcome = 0;
        ...
        private decimal? GetGoodIncome(ExtraEntities context, DateTime st, DateTime fin, Division div, Good good, Storehouse store)
        {
        ...
        private decimal GetGoodLeftForDate(ExtraEntities context, DateTime date, Division div, Good good, Storehouse store)
        {
            var income = 0;
        ...
        private decimal? ProcessBuyProc(Guid? divisionId, ExtraEntities context, IEnumerable<Ticket> i, DateTime st, DateTime fin)
        {
