...
namespace ExtraClub.ServerCore
{
    public static class UserManagement
    {
        ...
        {
            using (var context = new ExtraEntities/*.GetInstance*/())
            {
        ...
        public static User GetUser(ExtraEntities context)
        {
        ...
        public static User GetUser(ExtraEntities context, params string[] includes)
        {
        ...
        public static List<Employee> GetEmployeesWithPermission(ExtraEntities context, Guid? companyId, Guid? divsionId, string permissionKey)
        {
        ...
        internal static Guid GetCompanyIdOrDefaultId(ExtraEntities context)
        {
            if (OperationContext.Current == null)
            {
