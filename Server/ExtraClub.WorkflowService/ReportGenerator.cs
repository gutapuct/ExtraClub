...
namespace ExtraClub.WorkflowService
{
    public class ReportGenerator
    {
        ...
        ExtraEntities Context = new ExtraEntities();
        DateTime Date;
        ...
        public void Run()
        {
            ...
            foreach(var userSet in reports)
            {
                ...
                var reportInfos = ReportsCore.GetUserReportsList().Where(i => i.Type == ExtraClub.ServiceModel.Reports.ReportType.Stored || i.Type == ExtraClub.ServiceModel.Reports.ReportType.Code)
                    .GroupBy(i => i.Key)
