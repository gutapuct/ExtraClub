...
namespace TonusClub.ServerCore
{
    public static class Extensions
    {
        ...
        {
            object obj;
            context.TryGetObjectByKey(new EntityKey("TonusEntities." + setName,
        ...
        {
            return DateTime.Today.AddHours(new TonusEntities().LocalSettings.Any() ? 0 : company.UtcCorr);
        }

        public static DateTime UtcNow(this Company company)
        {
            return DateTime.Now.AddHours(new TonusEntities().LocalSettings.Any() ? 0 : company.UtcCorr);
        }
    }
}
