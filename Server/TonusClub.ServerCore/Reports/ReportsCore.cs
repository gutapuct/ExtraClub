...
namespace TonusClub.ServerCore
{
    public static class ReportsCore
    {
        ...
        {
            var type = Type.GetType(typeName + ", TonusClub.ServiceModel");
            if(type != null)
            {
        ...
        private static DataTable ExecuteStoredProcedure(TonusEntities context, ReportInfo rep, Dictionary<string, object> parameters)
        {
