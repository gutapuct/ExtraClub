...
namespace TonusClub.ServerCore
{
    internal class ScheduleAnalyzer
    {
        ...
        private Dictionary<Guid, List<TreatementEventInfo>> GetDivisionTreatmentEvents(TonusEntities context)
        {
        ...
        private Dictionary<Guid, List<TreatmentEvent>> GenerateCustomerEvents(TonusEntities context)
        {
        ...
        /// </summary>
        private Dictionary<Guid, List<Treatment>> GenerateTreatmentGroups(TonusEntities context)
        {
