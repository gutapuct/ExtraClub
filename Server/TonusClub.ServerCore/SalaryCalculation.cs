...
namespace TonusClub.ServerCore
{
    ...
    {
        public static decimal Get01TotalSalesPercent(TonusEntities context, Guid? divisionId, DateTime calcStart, DateTime calcEnd, Guid? companyId = null)
        {
        ...
        public static decimal Get01aTotalCorporateSalesPercent(TonusEntities context, Guid? divisionId, DateTime calcStart, DateTime calcEnd, Guid? companyId = null)
        {
            var month = new DateTime(calcStart.Year, calcStart.Month, 1);
            if(divisionId.HasValue)
            {
        ...
        internal static decimal Get02GroupSales(TonusEntities context, Guid divisionId, DateTime calcStart, int group)
        {
        ...
        internal static decimal Get03NewTicketsAmount(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get04DicsountedTickets(TonusEntities context, Guid divisionId, DateTime calcStart, decimal discount)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get05RetryTicketsAmount(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
            return context.Tickets.Count(i => i.CreatedOn >= calcStart && i.CreatedOn < calcEnd && i.DivisionId == divisionId && i.Customer.Tickets.Any(j => j.CreatedOn < i.CreatedOn));
        }

        internal static decimal Get06TicketType(TonusEntities context, Guid divisionId, DateTime calcStart, Guid ticketType)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get07CardType(TonusEntities context, Guid divisionId, DateTime calcStart, Guid cardType)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get08GoodGroup(TonusEntities context, Guid divisionId, DateTime calcStart, Guid goodCategory)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get09Good(TonusEntities context, Guid divisionId, DateTime calcStart, Guid goodId)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get10Action(TonusEntities context, Guid divisionId, DateTime calcStart, Guid actionId)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get11AfterGuest(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
            try
            {
        ...
        internal static decimal Get12AfterVisit(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
            try
            {
        ...
        internal static decimal Get13AvgSpent(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
            return (context.GetAvgSpendings(calcStart, calcEnd, divisionId).First()) ?? 0;
        }

        internal static decimal Get14ClubVisit(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get15TreatmentTypeVisit(TonusEntities context, Guid divisionId, DateTime calcStart, Guid treatmentTypeId)
        {
            var calcEnd = calcStart.AddMonths(1);
            var div = context.Divisions.Single(i => i.Id == divisionId);
            if(!div.CloseTime.HasValue || !div.OpenTime.HasValue) return 0;
        ...
        internal static decimal Get16TreatmentVisit(TonusEntities context, Guid divisionId, DateTime calcStart, Guid treatmentId)
        {
            var calcEnd = calcStart.AddMonths(1);
            var div = context.Divisions.Single(i => i.Id == divisionId);
            if(!div.CloseTime.HasValue || !div.OpenTime.HasValue) return 0;
        ...
        internal static decimal Get18CertByGroup(TonusEntities context, Guid divisionId, DateTime calcStart, Guid catId)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get22AmTicketsFromCardType(TonusEntities context, Guid divisionId, DateTime calcStart, Guid cardType)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get23CostTicketsFromCardType(TonusEntities context, Guid divisionId, DateTime calcStart, Guid cardType)
        {
            var calcEnd = calcStart.AddMonths(1);
            var list = new List<Customer>();
            var ls = context.CustomerCards.Where(i => i.EmitDate < calcEnd).GroupBy(i => i.Customer);
        ...
        internal static decimal Get24GoodsFromCardType(TonusEntities context, Guid divisionId, DateTime calcStart, Guid cardType)
        {
            var calcEnd = calcStart.AddMonths(1);
            var list = new List<Customer>();
            var ls = context.CustomerCards.Where(i => i.EmitDate < calcEnd).GroupBy(i => i.Customer);
        ...
        internal static decimal Get17ParameterizedVisit(TonusEntities context, Guid divisionId, DateTime calcStart, int dayBits, TimeSpan openTime, TimeSpan closeTime)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get19NewCorporates(TonusEntities context, Guid divisionId, DateTime calcStart)
        {
            var calcEnd = calcStart.AddMonths(1);
        ...
        internal static decimal Get20CategorySales(TonusEntities context, Guid divisionId, DateTime calcStart, int type, Guid catId)
        {
            var calcEnd = calcStart.AddMonths(1);
            if(type == 0)
            {
        ...
        internal static decimal Get21CategorySalesNum(TonusEntities context, Guid divisionId, DateTime calcStart, int type, Guid catId)
        {
            var calcEnd = calcStart.AddMonths(1);
            if(type == 0)
            {
        ...
        internal static decimal Get25KPD(TonusEntities context, DateTime calcStart, Employee employee)
        {
            var calcEnd = calcStart.AddMonths(1);
