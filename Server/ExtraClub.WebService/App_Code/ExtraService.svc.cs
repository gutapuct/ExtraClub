...
using System.Linq;
using Core = ExtraClub.ServerCore.Core;
...
public class ExtraService : IExtraService
{
    ...
    {
        var res = Core.GetOneRecord<Ticket>("ExtraEntities.Tickets", "Id", ticketId, true);
        return res;
    }
    ...
    {
        var res = Core.GetOneRecord<SolariumVisit>("ExtraEntities.SolariumVisits", "Id", visitId, true);
        res.Init();
        return res;
    }
    ...
    {
        return new ExtraEntities().CustomerTargetTypes.Where(i => i.IsAvail).ToDictionary(i => i.Id, i => i.Name);
    }
    ...
    public List<ExtraClub.ServiceModel.Ssh.SshFolder> GetSshFolders()
    {
