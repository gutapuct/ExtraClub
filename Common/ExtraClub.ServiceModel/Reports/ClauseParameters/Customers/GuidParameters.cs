...
namespace ExtraClub.ServiceModel.Reports.ClauseParameters.Customers
{
    ...
    public class GuidParameter3 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetAdvertTypes().ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameter3a : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetAdvertGroups().ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameter4 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetTicketTypes(false).ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameter7 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetAllGoods(Guid.Empty).ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameter8 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetAllContras().ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameter10 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetTreatmentPrograms().ToDictionary(j => (object)j.Id, j => j.ProgramName));
            }
        }
    ...
    public class GuidParameter13 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetUsers().ToDictionary(j => (object)j.UserId, j => j.FullName));
            }
        }
    ...
    public class GuidParameter17 : ClauseGuidParameter<Customer>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetAllStatuses().ToDictionary(j => (object)j.Key, j => j.Value));
            }
        }
