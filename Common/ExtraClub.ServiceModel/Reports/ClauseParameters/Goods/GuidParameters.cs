...
namespace ExtraClub.ServiceModel.Reports.ClauseParameters.Goods
{
    ...
    public class GuidParameterGo2 : ClauseGuidParameter<Good>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetDictionaryList("ProductTypes").ToDictionary(j => (object)j.Key, j => j.Value));
            }
        }
    ...
    public class GuidParameterGo3 : ClauseGuidParameter<Good>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetDictionaryList("Manufacturers").ToDictionary(j => (object)j.Key, j => j.Value));
            }
        }
    ...
    public class GuidParameterGo4 : ClauseGuidParameter<Good>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetDictionaryList("UnitTypes").ToDictionary(j => (object)j.Key, j => j.Value));
            }
        }
    ...
    public class GuidParameterGo5 : ClauseGuidParameter<Good>
    {
        public override Func<IExtraService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<IExtraService, Dictionary<object, string>>(i => i.GetDictionaryList("GoodsCategories").ToDictionary(j => (object)j.Key, j => j.Value));
            }
        }
