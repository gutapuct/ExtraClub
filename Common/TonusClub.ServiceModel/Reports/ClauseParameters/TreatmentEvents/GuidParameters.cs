...
namespace TonusClub.ServiceModel.Reports.ClauseParameters.TreatmentEvents
{
    ...
    public class GuidParameterEv2 : ClauseGuidParameter<TreatmentEvent>
    {
        public override Func<ITonusService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<ITonusService, Dictionary<object, string>>(i => i.GetAllTreatmentTypeGroups().ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameterEv3 : ClauseGuidParameter<TreatmentEvent>
    {
        public override Func<ITonusService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<ITonusService, Dictionary<object, string>>(i => i.GetAllTreatmentConfigs().Where(j => j.IsActive).ToDictionary(j => (object)j.Id, j => j.Name));
            }
        }
    ...
    public class GuidParameterEv6 : ClauseGuidParameter<TreatmentEvent>
    {
        public override Func<ITonusService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<ITonusService, Dictionary<object, string>>(i => i.GetAllTreatments(Guid.Empty).ToDictionary(j => (object)j.Id, j => j.DisplayName));
            }
        }
    ...
    public class GuidParameterEv11 : ClauseGuidParameter<TreatmentEvent>
    {
        public override Func<ITonusService, Dictionary<object, string>> GetValuesFunction
        {
            get
            {
                return new Func<ITonusService, Dictionary<object, string>>(c => c.GetTreatmentPrograms().ToDictionary(i => (object)i.Id, i => i.ProgramName));
            }
        }
