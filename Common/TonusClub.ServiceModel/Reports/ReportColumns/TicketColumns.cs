...
#if BEAUTINIKA
        [Description("Количество дополнительных единиц")]
        public int fi11a { get { return (int)entity.ExtraUnitsAmount; } }
        [Description("Остаток дополнительных единиц")]
        [Include("UnitCharges")]
        public int fi12a { get { entity.InitUnitsOut(); return (int)entity.ExtraUnitsLeft; } }
        [Description("Потрачено дополнительных единиц")]
        [Include("UnitCharges")]
        public int fi13a { get { entity.InitUnitsOut(); return (int)entity.ExtraUnitsOut; } }
#endif
