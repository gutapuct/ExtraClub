...
namespace TonusClub.ServiceModel
{
    ...
    [DataContract]
    [Serializable]
    public partial class ContraIndication : INotifyPropertyChanged
    {
        ...
        private void FixupCustomers(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                ...
                {
                    if (!item.ContraIndications.Contains(this))
                    {
                        item.ContraIndications.Add(this);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Customer item in e.OldItems)
                {
                    if (item.ContraIndications.Contains(this))
                    {
                        item.ContraIndications.Remove(this);
                    }
                }
            }
        }
