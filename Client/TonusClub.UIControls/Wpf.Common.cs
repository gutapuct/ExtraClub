...
namespace TonusClub.UIControls
{
    ...
    public class VisibilityAnimation
    {
        ...
        public double StartupOpacity { get; set; }

        public static double GetStartupOpacity(DependencyObject obj)
        {
            return (double)obj.GetValue(StartupOpacityProperty);
        }

        public static void SetStartupOpacity(DependencyObject obj, double value)
        {
            obj.SetValue(StartupOpacityProperty, value);
        }

        public static readonly DependencyProperty StartupOpacityProperty =
    DependencyProperty.RegisterAttached(
            ...
            object baseValue)
        {
            ...
            if (visibility == Visibility.Collapsed || visibility == Visibility.Hidden)
            {
                ...
                doubleAnimation.From = GetStartupOpacity(dependencyObject);
            ...
            else
            {
                ...
                doubleAnimation.To = GetStartupOpacity(dependencyObject);
            }
