...
using TonusClub.ClientDal;
using TonusClub.ClientDal.Wizards.NewClub;
using TonusClub.ClientDal.Wizards.NewCompany;
...
namespace TonusClub.UIControls
{
    public class ClientContext : IClientContext
    {
        ...
        private ChannelFactory<ITonusService> _channelFactory;

        private ITonusService CreateChannel()
        {
        ...
        private bool Authenticate(string address = "", string message = null)
        {
            ...
            _channelFactory = new ChannelFactory<ITonusService>("TCEndpoint");
            ...
            catch (EndpointNotFoundException)
            {
                ...
                //var addr = "";
                //TonusWindow.Prompt(new DialogParameters
                //{
        ...
        public void ExecuteMethod(Action<ITonusService> method)
        {
            ExecuteMethod(i =>
            {
                method(i);
        ...
        public TResult ExecuteMethod<TResult>(Func<ITonusService, TResult> method)
        {
        ...
        public Task<TResult> ExecuteMethodAsync<TResult>(Func<ITonusService, TResult> method)
        {
        ...
        public LocalSetting GetLocalSettings()
        {
            ...
            {
                TonusWindow.Alert(Localization.Resources.RegionalError, ex.Message);
                return null;
            }
        }
        ...
        public void UpdateLicenseKey()
        {
            ...
            {
                TonusWindow.Alert(Localization.Resources.KeyUpdateError, ex.Message);
            }
        }
