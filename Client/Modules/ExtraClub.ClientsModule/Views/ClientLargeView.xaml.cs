...
using ExtraClub.Clients.Business;
...
using WindowBase = ExtraClub.UIControls.WindowBase;
...
namespace ExtraClub.Clients.Views
{
    public partial class ClientLargeView : ILargeSection
    {
        ...
        private void ActivateTicketButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ExtraWindow.Confirm(UIControls.Localization.Resources.TicketActivation,
        ...
        {
            ExtraWindow.Confirm(UIControls.Localization.Resources.CancelSelected,
        ...
        private void EventsViewMouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                if (item != null)
                {
                    ExtraWindow.Prompt(UIControls.Localization.Resources.Comment,
        ...
        private void Image_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (_model.CurrentCustomer == null)
            {
                ExtraWindow.Alert("Не выбран клиент", "Выберите клиента для того, чтобы загрузить фотографию!");
            }
            else
            {
