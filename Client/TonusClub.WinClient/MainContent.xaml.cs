...
using TonusClub.ScheduleModule.Views.Treatments;
using TonusClub.ScheduleModule.Views.Solarium;
using TonusClub.ScheduleModule.Views;
using TonusClub.TreatmentsModule.ViewModels;
using TonusClub.TreatmentsModule.Views;
using TonusClub.TreatmentsModule.Views.Windows;
using TonusClub.Clients.ViewModels;
using TonusClub.Clients.Views;
using TonusClub.Clients.Views.ContainedControls;
using TonusClub.OrganizerModule.ViewModels;
using TonusClub.OrganizerModule.Views;
using TonusClub.OrganizerModule.Views.Ankets;
using TonusClub.OrganizerModule.Views.Calls;
using TonusClub.OrganizerModule.Views.Claims;
using TonusClub.OrganizerModule.Views.Files;
using TonusClub.OrganizerModule.Business;
using TonusClub.TurnoverModule.Views.ContainedControls;
using TonusClub.TurnoverModule.ViewModels;
using TonusClub.TurnoverModule.Views;
using TonusClub.TurnoverModule.Views.Windows;
using TonusClub.EmployeesModule.ViewModels;
using TonusClub.EmployeesModule.Views;
using TonusClub.EmployeesModule.Views.ContainedControls.Employees.Windows;
using TonusClub.Reports.ViewModels;
using TonusClub.Reports.Views;
using TonusClub.SettingsModule.Views.ContainedControls;
using TonusClub.SettingsModule.ViewModels;
using TonusClub.SettingsModule.Views;
