...
using System.IO;
using TonusClub.WinClient.Windows;
    ...
    public partial class App
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            try
            {
                ...
                _wnd.Topmost = true;
                var stream = System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("TonusClub.WinClient.Images.SplashScreen1.png");
...

                {
                    ...
                    if(_bootstrapper.Shell != null)
                    {
                        ...
                        LocalizationManager.Manager = new TonusClub.UIControls.Localization.CustomLocalizationManager();
                    }
                }
